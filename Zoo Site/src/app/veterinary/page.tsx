...
export default function VeterinaryPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100vh-10rem)] bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-2">Veterinary Care</h1>
      <p className="text-gray-500 max-w-md mb-8">
        This module is currently under active development. Medical records, checkups, and treatment plans will be available here.
      </p>
